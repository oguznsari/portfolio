          ...
          <tr style="width:100%">
            <td>
              <a href=${osariGithubImage}>
                <img alt="Oğuzhan" src=${osariGithubImage} width="48" height="48" style="display:block; outline:none; border:none; text-decoration:none; border-radius: 1rem;" /> 
              </a>
              <h1 style="font-size:20px;font-weight:bold;margin-top:48px">📮 New message received from portfolio</h1>
              ...
              <br>
              <p style="font-size:16px;line-height:26px;margin:16px 0">Best,<br />- Oğuzhan SARI</p>
              <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#dddddd;margin-top:48px" />
              <p style="font-size:12px;line-height:24px;margin:16px 0;color:#8898aa;margin-left:4px">&copy; Oğuzhan SARI</p>
            </td>
          </tr>
        </table>
      </body>
