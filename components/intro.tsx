    ...
    return (
        <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
            ...
            >
                ...
                <span className="font-bold">{yearsOfExperience} years</span> of experience. I enjoy building{" "}
            ...
            >
                ...
                <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full 
                    ...
                    href="https://www.linkedin.com/in/oguznsari" target="_blank">
                    <BsLinkedin />
                </a>
                ...
                <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full 
                    focus:scale-[1.15] hover:scale-[1.15] active:scale-105 hover:text-gray-950 transition 
                    cursor-pointer border border-black/10"
                    href="https://github.com/oguznsari" target="_blank">
                    <BsGithub />
                </a>
            </motion.div>
        </section>
