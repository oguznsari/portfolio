  ...
  return (
    <button
      ...
      className="group flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-gray-900 text-white
          ...
          disabled:scale-100 disabled:bg-opacity-65 dark:bg-white dark:bg-opacity-10 font-mono"
      disabled={pending}
    >
      {" "}
      {pending ? (
        <div className="h-5 w-5 animate-spin rounded-full border-b-2 border-color-white"></div>
      ) : (
        <>
          Submit{" "}
